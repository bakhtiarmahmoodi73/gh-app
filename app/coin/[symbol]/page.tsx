...
<div className="  w-[375px] h-[3837px] tablet:w-[834px] tablet:h-[2860px] laptop:w-[1440px] laptop:h-[3065px] top-[0px]">
        <div className=" absolute shadow border-[#ffffff] bg-[#ffffff] w-[337px] h-[799px] top-[104px] left-[20px] rounded-[30px] blur-[#0D1A8E14] tablet:w-[734px] tablet:h-[448px] tablet:top-[114px] tablet:left-[50px] laptop:w-[1139px] laptop:h-[481px] laptop:top-[164px] laptop:left-[150px] ">
          ...
          <p className="absolute font-iranSansnumber text-[#147D03] font-[400] text-[12px] leading-[18px] w-[39px] h-[18px] top-[164px] left-[25px] tablet:top-[186px] tablet:left-[415px] laptop:w-[52px] laptop:h-[24px] laptop:top-[214px] laptop:left-[598px] laptop:text-[16px] laptop:leading-[24px]">
            {" "}
            +1.53%{" "}
          </p>
          ...
          <p className="absolute font-iranSansnumber text-[#147D03] font-[400] text-[12px] leading-[18px] w-[111px] h-[18px] top-[208px] left-[8px] tablet:top-[236px] tablet:left-[405px] laptop:w-[130px] laptop:h-[24px] laptop:top-[265px] laptop:left-[595px] laptop:text-[16px] laptop:leading-[24px]">
            {" "}
            4.423.995.207{" "}
          </p>
          <span className="absolute font-iranSansnumber text-[#000000] font-[400] text-[12px] leading-[18px] w-[20px] h-[18px] top-[208px] left-[27px] tablet:top-[236px] tablet:left-[420px] laptop:w-[30px] laptop:h-[24px] laptop:top-[265px] laptop:left-[598px] laptop:text-[16px] laptop:leading-[24px]">
            تومان
          </span>
          ...
          <p className="absolute font-iranSansnumber text-[#FF6868] font-[400] text-[12px] leading-[18px] w-[112px] h-[18px] top-[251px] left-[8px] tablet:top-[286px] tablet:left-[405px] laptop:w-[130px] laptop:h-[24px] laptop:top-[316px] laptop:left-[595px] laptop:text-[16px] laptop:leading-[24px]">
            {" "}
            4.372.909.558{" "}
          </p>
